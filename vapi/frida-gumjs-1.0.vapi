namespace Gum {
	...
	public interface ScriptBackend : GLib.Object {
		...
		public async Script create_from_bytes (string name, Bytes bytes, GLib.Cancellable? cancellable = null) throws GLib.IOError;
		public Script create_from_bytes_sync (string name, Bytes bytes, GLib.Cancellable? cancellable = null) throws GLib.IOError;

		public async Bytes compile (string source, GLib.Cancellable? cancellable = null) throws GLib.IOError;
		public Bytes compile_sync (string source, GLib.Cancellable? cancellable = null) throws GLib.IOError;
