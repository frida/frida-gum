                                  ...
                                  gsize n_pages)
{
  ...
  for (page = base; page != end; page += page_size)
  {
    ...
    current_block->count++;
    current_block->end = page + page_size;
  }

  g_assert (current_block == NULL || current_block->count != 0);
}
