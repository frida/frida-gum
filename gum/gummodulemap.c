...
static gint gum_module_details_compare_base (GumModule * lhs_module,
                     ...
                     GumAddress address)
{
  ...
  return bsearch (&bare_address, self->modules->pdata, self->modules->len,
      sizeof (GumModule *),
      (GCompareFunc) gum_module_compare_to_key);
}
...
gum_module_map_update (GumModuleMap * self)
{
  ...
  g_ptr_array_sort (self->modules, (GCompareFunc) gum_module_details_compare_base);
}
...
static gint
gum_module_details_compare_base (GumModule * lhs_module,
                                 GumModule * rhs_module)
{
  GumAddress lhs;
  GumAddress rhs;
                           ...
                           GumModule ** member)
{
  ...
  const GumMemoryRange * m = gum_module_get_range (*member);
