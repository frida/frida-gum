...
gum_stalker_class_init (GumStalkerClass * klass)
{
  ...
  g_object_class_install_property (object_class, PROP_IC_ENTRIES,
      ...
      32, 2, G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
                                            ...
                                            GumX86Writer * cw)
{
  ...
  gum_x86_writer_put_mov_reg_reg_offset_ptr (cw, GUM_REG_XAX,
      GUM_REG_XAX, offsetof (GumExecCtx, code_slab));

  if (offsetof (GumCodeSlab, slab) != 0)
    gum_x86_writer_put_add_reg_imm (cw, GUM_REG_XAX, offsetof(GumCodeSlab, slab));
  ...
  /* data(XCX) = curr->data */
  gum_x86_writer_put_mov_reg_reg_offset_ptr (cw, GUM_REG_XCX,
      GUM_REG_XAX, offsetof(GumSlab, data));

  /* IF return_address < data THEN continue */
  gum_x86_writer_put_cmp_reg_offset_ptr_reg (cw,
      GUM_REG_XSP, stack_delta, GUM_REG_XCX);
  ...
  gum_x86_writer_put_mov_reg_reg_offset_ptr (cw, GUM_REG_EDX,
      GUM_REG_XAX, offsetof(GumSlab, offset));
  ...
  /* cur = cur->next; */
  gum_x86_writer_put_mov_reg_reg_offset_ptr (cw, GUM_REG_XAX,
      GUM_REG_XAX, offsetof (GumSlab, next));
