                           ...
                           GumX86Writer * cw)
{
  ...
  //  0xcc,
    0xc4, 0xe3, 0x7d, 0x39, 0x04, 0x24, 0x01,                         // vextracti128 ymm0, [rsp+0x0], 1
    0xc4, 0xe3, 0x7d, 0x39, 0x4c, 0x24, 0x10, 0x01,                   // vextracti128 ymm1, [rsp+0x10], 1
    0xc4, 0xe3, 0x7d, 0x39, 0x54, 0x24, 0x20, 0x01,                   // vextracti128 ymm2, [rsp+0x20], 1
    0xc4, 0xe3, 0x7d, 0x39, 0x5c, 0x24, 0x30, 0x01,                   // vextracti128 ymm3, [rsp+0x30], 1
    0xc4, 0xe3, 0x7d, 0x39, 0x64, 0x24, 0x40, 0x01,                   // vextracti128 ymm4, [rsp+0x40], 1
    0xc4, 0xe3, 0x7d, 0x39, 0x6c, 0x24, 0x50, 0x01,                   // vextracti128 ymm5, [rsp+0x50], 1
    0xc4, 0xe3, 0x7d, 0x39, 0x74, 0x24, 0x60, 0x01,                   // vextracti128 ymm6, [rsp+0x60], 1
    0xc4, 0xe3, 0x7d, 0x39, 0x7c, 0x24, 0x70, 0x01,                   // vextracti128 ymm7, [rsp+0x70], 1
    0xc4, 0x63, 0x7d, 0x39, 0x84, 0x24, 0x80, 0x00, 0x00, 0x00, 0x01, // vextracti128 ymm8, [rsp+0x80], 1
    0xc4, 0x63, 0x7d, 0x39, 0x8c, 0x24, 0x90, 0x00, 0x00, 0x00, 0x01, // vextracti128 ymm9, [rsp+0x90], 1
    0xc4, 0x63, 0x7d, 0x39, 0x94, 0x24, 0xa0, 0x00, 0x00, 0x00, 0x01, // vextracti128 ymm10, [rsp+0xA0], 1
    0xc4, 0x63, 0x7d, 0x39, 0x9c, 0x24, 0xb0, 0x00, 0x00, 0x00, 0x01, // vextracti128 ymm11, [rsp+0xB0], 1
    0xc4, 0x63, 0x7d, 0x39, 0xa4, 0x24, 0xc0, 0x00, 0x00, 0x00, 0x01, // vextracti128 ymm12, [rsp+0xC0], 1
    0xc4, 0x63, 0x7d, 0x39, 0xac, 0x24, 0xd0, 0x00, 0x00, 0x00, 0x01, // vextracti128 ymm13, [rsp+0xD0], 1
    0xc4, 0x63, 0x7d, 0x39, 0xb4, 0x24, 0xe0, 0x00, 0x00, 0x00, 0x01, // vextracti128 ymm14, [rsp+0xE0], 1
    0xc4, 0x63, 0x7d, 0x39, 0xbc, 0x24, 0xf0, 0x00, 0x00, 0x00, 0x01  // vextracti128 ymm15, [rsp+0xF0], 1
  };
#else
  guint8 upper_ymm_saver[] = {
    0xc4, 0xc3, 0x7d, 0x39, 0x04, 0x24, 0x01,       // vextracti128 ymm0, [esp+0x0], 1
    0xc4, 0xc3, 0x7d, 0x39, 0x4c, 0x24, 0x10, 0x01, // vextracti128 ymm1, [esp+0x10], 1
    0xc4, 0xc3, 0x7d, 0x39, 0x54, 0x24, 0x20, 0x01, // vextracti128 ymm2, [esp+0x20], 1
    0xc4, 0xc3, 0x7d, 0x39, 0x5c, 0x24, 0x30, 0x01, // vextracti128 ymm3, [esp+0x30], 1
    0xc4, 0xc3, 0x7d, 0x39, 0x64, 0x24, 0x40, 0x01, // vextracti128 ymm4, [esp+0x40], 1
    0xc4, 0xc3, 0x7d, 0x39, 0x6c, 0x24, 0x50, 0x01, // vextracti128 ymm5, [esp+0x50], 1
    0xc4, 0xc3, 0x7d, 0x39, 0x74, 0x24, 0x60, 0x01, // vextracti128 ymm6, [esp+0x60], 1
    0xc4, 0xc3, 0x7d, 0x39, 0x7c, 0x24, 0x70, 0x01  // vextracti128 ymm7, [esp+0x70], 1
  };
#endif
                           ...
                           GumX86Writer * cw)
{
  ...
  guint8 upper_ymm_restorer[] = {
   // 0xcc,
    0xc4, 0xe3, 0x7d, 0x38, 0x04, 0x24, 0x01,                         // vinserti128 ymm0, ymm0, [rsp+0x0], 1
    0xc4, 0xe3, 0x75, 0x38, 0x4c, 0x24, 0x10, 0x01,                   // vinserti128 ymm1, ymm1, [rsp+0x10], 1
    0xc4, 0xe3, 0x6d, 0x38, 0x54, 0x24, 0x20, 0x01,                   // vinserti128 ymm2, ymm2, [rsp+0x20], 1
    0xc4, 0xe3, 0x65, 0x38, 0x5c, 0x24, 0x30, 0x01,                   // vinserti128 ymm3, ymm3, [rsp+0x30], 1
    0xc4, 0xe3, 0x5d, 0x38, 0x64, 0x24, 0x40, 0x01,                   // vinserti128 ymm4, ymm4, [rsp+0x40], 1
    0xc4, 0xe3, 0x55, 0x38, 0x6c, 0x24, 0x50, 0x01,                   // vinserti128 ymm5, ymm5, [rsp+0x50], 1
    0xc4, 0xe3, 0x4d, 0x38, 0x74, 0x24, 0x60, 0x01,                   // vinserti128 ymm6, ymm6, [rsp+0x60], 1
    0xc4, 0xe3, 0x45, 0x38, 0x7c, 0x24, 0x70, 0x01,                   // vinserti128 ymm7, ymm7, [rsp+0x70], 1
    0xc4, 0x63, 0x3d, 0x38, 0x84, 0x24, 0x80, 0x00, 0x00, 0x00, 0x01, // vinserti128 ymm8, ymm8, [rsp+0x80], 1
    0xc4, 0x63, 0x35, 0x38, 0x8c, 0x24, 0x90, 0x00, 0x00, 0x00, 0x01, // vinserti128 ymm9, ymm9, [rsp+0x90], 1
    0xc4, 0x63, 0x2d, 0x38, 0x94, 0x24, 0xa0, 0x00, 0x00, 0x00, 0x01, // vinserti128 ymm10, ymm10, [rsp+0xA0], 1
    0xc4, 0x63, 0x25, 0x38, 0x9c, 0x24, 0xb0, 0x00, 0x00, 0x00, 0x01, // vinserti128 ymm11, ymm11, [rsp+0xB0], 1
    0xc4, 0x63, 0x1d, 0x38, 0xa4, 0x24, 0xc0, 0x00, 0x00, 0x00, 0x01, // vinserti128 ymm12, ymm12, [rsp+0xC0], 1
    0xc4, 0x63, 0x15, 0x38, 0xac, 0x24, 0xd0, 0x00, 0x00, 0x00, 0x01, // vinserti128 ymm13, ymm13, [rsp+0xD0], 1
    0xc4, 0x63, 0x0d, 0x38, 0xb4, 0x24, 0xe0, 0x00, 0x00, 0x00, 0x01, // vinserti128 ymm14, ymm14, [rsp+0xE0], 1
    0xc4, 0x63, 0x05, 0x38, 0xbc, 0x24, 0xf0, 0x00, 0x00, 0x00, 0x01  // vinserti128 ymm15, ymm15, [rsp+0xF0], 1
  };
#else
  guint8 upper_ymm_restorer[] = {
    0xc4, 0xc3, 0x7d, 0x38, 0x04, 0x24, 0x01,       // vinserti128 ymm0, ymm0, [esp+0x0], 1
    0xc4, 0xc3, 0x75, 0x38, 0x4c, 0x24, 0x10, 0x01, // vinserti128 ymm1, ymm1, [esp+0x10], 1
    0xc4, 0xc3, 0x6d, 0x38, 0x54, 0x24, 0x20, 0x01, // vinserti128 ymm2, ymm2, [esp+0x20], 1
    0xc4, 0xc3, 0x65, 0x38, 0x5c, 0x24, 0x30, 0x01, // vinserti128 ymm3, ymm3, [esp+0x30], 1
    0xc4, 0xc3, 0x5d, 0x38, 0x64, 0x24, 0x40, 0x01, // vinserti128 ymm4, ymm4, [esp+0x40], 1
    0xc4, 0xc3, 0x55, 0x38, 0x6c, 0x24, 0x50, 0x01, // vinserti128 ymm5, ymm5, [esp+0x50], 1
    0xc4, 0xc3, 0x4d, 0x38, 0x74, 0x24, 0x60, 0x01, // vinserti128 ymm6, ymm6, [esp+0x60], 1
    0xc4, 0xc3, 0x45, 0x38, 0x7c, 0x24, 0x70, 0x01  // vinserti128 ymm7, ymm7, [esp+0x70], 1
  };
#endif

  gum_x86_writer_put_bytes (cw, upper_ymm_restorer, sizeof (upper_ymm_restorer));
