...
gboolean gum_arm64_writer_put_label (GumArm64Writer * self, gconstpointer id);
...
gboolean gum_arm64_writer_put_branch_address (GumArm64Writer * self,
    GumAddress address);

gboolean gum_arm64_writer_can_branch_imm (GumAddress from, GumAddress to);
gboolean gum_arm64_writer_put_b_imm (GumArm64Writer * self, GumAddress address);
gboolean gum_arm64_writer_put_b_label (GumArm64Writer * self,
    gconstpointer label_id);
gboolean gum_arm64_writer_put_b_cond_label (GumArm64Writer * self, arm64_cc cc,
    gconstpointer label_id);
gboolean gum_arm64_writer_put_bl_imm (GumArm64Writer * self,
    GumAddress address);
gboolean gum_arm64_writer_put_br_reg (GumArm64Writer * self, arm64_reg reg);
gboolean gum_arm64_writer_put_blr_reg (GumArm64Writer * self, arm64_reg reg);
void gum_arm64_writer_put_ret (GumArm64Writer * self);
gboolean gum_arm64_writer_put_cbz_reg_label (GumArm64Writer * self,
    arm64_reg reg, gconstpointer label_id);
gboolean gum_arm64_writer_put_cbnz_reg_label (GumArm64Writer * self,
    arm64_reg reg, gconstpointer label_id);
gboolean gum_arm64_writer_put_tbz_reg_imm_label (GumArm64Writer * self,
    arm64_reg reg, guint bit, gconstpointer label_id);
gboolean gum_arm64_writer_put_tbnz_reg_imm_label (GumArm64Writer * self,
    arm64_reg reg, guint bit, gconstpointer label_id);
...
gboolean gum_arm64_writer_put_ldr_reg_u64 (GumArm64Writer * self, arm64_reg reg,
    guint64 val);
...
gboolean gum_arm64_writer_put_ldp_reg_reg_reg_offset (GumArm64Writer * self,
    arm64_reg reg_a, arm64_reg reg_b, arm64_reg reg_src, gssize src_offset,
    GumArm64IndexMode mode);
gboolean gum_arm64_writer_put_stp_reg_reg_reg_offset (GumArm64Writer * self,
...
gboolean gum_arm64_writer_put_bytes (GumArm64Writer * self, const guint8 * data,
    guint n);
