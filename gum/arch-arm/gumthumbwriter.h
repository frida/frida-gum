...
void gum_thumb_writer_put_ldr_reg_address (GumThumbWriter * self, GumThumbReg reg, GumAddress address);
...
void gum_thumb_writer_put_add_reg_reg (GumThumbWriter * self, GumThumbReg dst_reg, GumThumbReg src_reg);
