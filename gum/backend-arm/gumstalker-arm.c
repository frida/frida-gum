                                          ...
                                          GumGeneratorContext * gc)
{
  ...
  switch (target->type)
  {
    ...
    case GUM_TARGET_DIRECT_REG_SHIFT: /* E.g. 'ADD pc, r1, r2 lsl #4' */
    {
       ...
       * it can be used to as a function parameter, R12 is unlikely to be our
       ...
       * clobbering and data stored there, and also do so without modifying SP
      ...
      gum_arm_writer_put_str_reg_reg_offset (cw, ARM_REG_R12, ARM_REG_SP, GUM_RED_ZONE_SIZE);
      ...
      gum_arm_writer_put_ldr_reg_reg_offset (cw, ARM_REG_R12, ARM_REG_SP, GUM_RED_ZONE_SIZE);
