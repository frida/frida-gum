...
G_GNUC_INTERNAL gchar * _gumjs_object_get_string (JSContextRef ctx,
    JSObjectRef object, const gchar * key);
G_GNUC_INTERNAL void _gumjs_object_set (JSContextRef ctx,
...
G_GNUC_INTERNAL GBytes * _gumjs_byte_array_get (JSContextRef ctx,
    JSValueRef value, JSValueRef * exception);
G_GNUC_INTERNAL GBytes * _gumjs_byte_array_try_get (JSContextRef ctx,
    JSValueRef value);

G_GNUC_INTERNAL gboolean _gumjs_callback_get_opt (JSContextRef ctx,
    JSValueRef value, JSObjectRef * callback, JSValueRef * exception);

G_GNUC_INTERNAL void _gumjs_throw (JSContextRef ctx,
