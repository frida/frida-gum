...
def generate_runtime_cmodule(output_dir, output, arch, input_dir, gum_dir, capstone_dir):
    ...
    inputs = [
        ...
        (os.path.join(input_dir, "..", "..", "ext", "tinycc", "include"), None, is_header, identity_transform, 'GUM_CMODULE_HEADER_TCC'),
        ...
        (os.path.dirname(capstone_dir), None, capstone_header_matches_arch, optimize_capstone_header, 'GUM_CMODULE_HEADER_FRIDA'),
    ]
