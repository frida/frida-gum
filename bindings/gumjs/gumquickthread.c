                       ...
                       GumQuickThread * parent)
{
  ...
  if ((details->flags & GUM_THREAD_FLAGS_HAS_NAME) != 0)
  {
    JS_DefinePropertyValue (ctx, thread,
  ...
  if ((details->flags & GUM_THREAD_FLAGS_HAS_STATE) != 0)
  {
    JS_DefinePropertyValue (ctx, thread,
  ...
  if ((details->flags & GUM_THREAD_FLAGS_HAS_CPU_CONTEXT) != 0)
  {
    JS_DefinePropertyValue (ctx, thread,
  ...
  if ((details->flags & GUM_THREAD_FLAGS_HAS_ENTRYPOINT) != 0)
  {
