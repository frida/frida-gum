...
static JSObjectRef gumjs_symbol_new (JSContextRef ctx, GumScriptSymbol * parent,
    GumSymbol ** symbol);
...
static JSObjectRef gumjs_pointer_array_to_value (JSContextRef ctx,
    GArray * pointers, GumScriptCore * core, JSValueRef * exception);
