...
gboolean
_gumjs_args_parse (const GumJscArgs * self,
                   const gchar * format,
                   ...)
{
...
_gumjs_cpu_context_new (JSContextRef ctx,
                        ...
                        GumJscCore * core)
{
  GumJscCpuContext * scc;

  scc = g_slice_new (GumJscCpuContext);
                            ...
                            JSObjectRef * handle)
{
  ...
  resource = g_slice_new (GumJscNativeResource);
