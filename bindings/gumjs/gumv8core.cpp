...
#define GUM_DEFINE_CPU_CONTEXT_ACCESSOR_FLAGS(A, R) \
  ...
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm0, xmm[0].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm1, xmm[1].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm2, xmm[2].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm3, xmm[3].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm4, xmm[4].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm5, xmm[5].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm6, xmm[6].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm7, xmm[7].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm8, xmm[8].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm9, xmm[9].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm10, xmm[10].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm11, xmm[11].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm12, xmm[12].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm13, xmm[13].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm14, xmm[14].q);
  GUM_DEFINE_CPU_CONTEXT_ACCESSOR_VECTOR (xmm15, xmm[15].q);
