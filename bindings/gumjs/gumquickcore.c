...
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x0)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x1)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x2)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x3)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x4)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x5)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x6)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x7)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x8)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x9)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x10)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x11)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x12)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x13)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x14)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x15)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x16)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x17)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x18)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x19)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x20)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x21)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x22)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x23)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x24)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x25)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x26)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x27)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x28)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x29)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x30)
GUM_DEFINE_CPU_CONTEXT_ACCESSOR_GPR (x31)
#endif
...
static const JSCFunctionListEntry gumjs_cpu_context_entries[] =
{
  ...
  GUM_EXPORT_CPU_CONTEXT_ACCESSOR (x27),
  GUM_EXPORT_CPU_CONTEXT_ACCESSOR (x28),
  GUM_EXPORT_CPU_CONTEXT_ACCESSOR (x29),
  GUM_EXPORT_CPU_CONTEXT_ACCESSOR (x30),
  GUM_EXPORT_CPU_CONTEXT_ACCESSOR (x31),
#endif
